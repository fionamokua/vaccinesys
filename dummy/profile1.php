...
<head>
    ...
    <link rel="stylesheet" href="/CVMS/CSS/myprofile.css">
...
<div class="left-container container">
    <div class="menu-box block"> <!-- MENU BOX (LEFT-CONTAINER) -->
        ...
        <ul class="menu-box-menu">
            ...
            <li>
                <a class="menu-box-tab" href="/CVMS/dummy/account.php"><span class="icon entypo-cog scnd-font-color"></span>Account Settings</a>
            </li>
            <li>
